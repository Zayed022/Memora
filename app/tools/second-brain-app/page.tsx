...
export const metadata: Metadata = {
  title: 'Best Second Brain App 2025 — AI-Powered | Memora',
  description: 'Memora is the second brain app that builds itself. Save anything, ask anything, forget nothing. Used by 10,000+ knowledge workers.',
  alternates: { canonical: 'https://memora.app/tools/second-brain-app' },
}
  ...
  return (
    <div className="min-h-screen bg-ink-50">
      ...
      <main className="max-w-2xl mx-auto px-6 py-16 text-center">
        ...
        <p className="text-lg text-ink-500 mb-10">Every other second brain app requires manual organisation. Memora organises itself using AI — no folders, no tagging, no effort.</p>
